...
public class QuizQues1 extends JFrame {
	...
	public QuizQues1() {
		...
		JLabel lblQuestion = new JLabel("Question  1  :   Which is not a UML diagram?");
		...
		JRadioButton rdbtnStateDiagram = new JRadioButton("State Diagram");
		...
		JRadioButton rdbtnSequenceDiagram = new JRadioButton("Sequence Diagram");
		...
		btnNewButton.setBounds(195, 388, 145, 23);
